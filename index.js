...
fetch("https://raw.githubusercontent.com/freeCodeCamp/ProjectReferenceData/master/global-temperature.json")
  ...
  .then(data => {
    ...
    renderHeatMap(monthlyVariance.map(d => ({
      ...d,
...
function renderHeatMap(dataset) {
  ...
  svg.selectAll("rect")
    ...
    .on("mouseover", (event, d) => {
      ...
      tooltip.html("<span class='hover-info'>" +
        d3.timeFormat("%Y - %B")(date) +
        "</span><span class='hover-info'>Temp: " +
        d3.format('.1f')(d.temp) + "&#8451;</span><span class='hover-info'>Variance: " +
        (d.variance > 0 ? "+" : "") +
  ...
  // Setting legend Height and Weight
